...
{
	public class ClearBombTarget : QuestTarget
	{
		public override bool IsEnable()
		{
			return AppearNodeConfig.Get().HasExtraType(ExtraType.Bomb);
		}
		...
		public override string GetDescription(QuestConfig Config)
		{
			...
			return string.Format(localizationUtility.GetString("Clear_Bomb_Count"), Config.NeedCount);
		}
