...
{
	public class PlayAchievementTarget : IAchievementTarget
	{
		...
		{
			return string.Format(LocalizationUtility.Get("Localization_achievement.json").GetString("Play"), info.GetConfig().NeedCount);
		}
