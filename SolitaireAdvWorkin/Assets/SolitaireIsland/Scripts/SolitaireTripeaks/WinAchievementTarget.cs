...
{
	public class WinAchievementTarget : IAchievementTarget
	{
		...
		{
			return string.Format(LocalizationUtility.Get("Localization_achievement.json").GetString("Win"), info.GetConfig().NeedCount);
		}
