...
{
	public class UseSnakeAchievementTarget : IAchievementTarget
	{
		...
		{
			return string.Format(LocalizationUtility.Get("Localization_achievement.json").GetString("Use_Snake"), info.GetConfig().NeedCount);
		}
