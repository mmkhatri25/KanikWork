...
{
	public class RowDayAchievementTarget : IAchievementTarget
	{
		...
		{
			return string.Format(LocalizationUtility.Get("Localization_achievement.json").GetString("RowDay"), info.GetConfig().NeedCount);
		}
