...
{
	public class UseRocketTarget : QuestTarget
	{
		...
		public override string GetDescription(QuestConfig Config)
		{
			...
			return string.Format(localizationUtility.GetString("Use_Rocket_Count"), Config.NeedCount);
		}

		public override string GetLeftDescription(QuestConfig Config)
		{
			string @string = LocalizationUtility.Get("Localization_quest.json").GetString("Use_Rocket_Count");
