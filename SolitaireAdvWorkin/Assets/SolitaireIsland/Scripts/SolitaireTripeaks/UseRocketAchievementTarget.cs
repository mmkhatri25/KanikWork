...
{
	public class UseRocketAchievementTarget : IAchievementTarget
	{
		...
		{
			return string.Format(LocalizationUtility.Get("Localization_achievement.json").GetString("Use_Rocket"), info.GetConfig().NeedCount);
		}
