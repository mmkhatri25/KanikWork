...
public class FullScreenGuide : MonoBehaviour
{
	...
	public void OnStart(string text, UnityAction unityAction)
	{
		DesLabel.text = text;
		if (unityAction != null)
		{
			...
			{
				base.gameObject.AddComponent<Button>().onClick.AddListener(unityAction);
			});
		}
	}
}
